  ...
  return (
    ...
    <Box p={10}>
      ...
      <Table variant="simple">
        <Tbody>
          <Tr>
            <Td fontWeight="bold" fontSize="1.3rem">Age</Td>
            <Td>{searchedData !== null ? searchedData?.age : ""}</Td>
          </Tr>
          <Tr>
            <Td fontWeight="bold" fontSize="1.3rem">Weight</Td>
            <Td>{searchedData !== null ? searchedData?.weight : ""}</Td>
          </Tr>
          <Tr>
            <Td fontWeight="bold" fontSize="1.3rem">Gender</Td>
            <Td>{searchedData !== null ? searchedData?.gender : ""}</Td>
          </Tr>
          <Tr>
            <Td fontWeight="bold" fontSize="1.3rem">Symptoms</Td>
            <Td>{searchedData !== null ? searchedData?.symptoms : ""}</Td>
          </Tr>
          <Tr>
            <Td fontWeight="bold" fontSize="1.3rem">Prescriptions</Td>
            <Td>
              <Table variant="unstyled">
                <Thead>
                  <Tr>
